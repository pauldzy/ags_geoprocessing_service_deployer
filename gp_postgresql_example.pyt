...
class NavigationService(object):
   ...
   def __init__(self):
      ...
      self.description = "The EPA Office of Water Navigation Service provides standard stream traversal on the NHDPlus hydrology network.  " + \
         ...
         "<a href='http://water.epa.gov/scitech/datait/tools/waters/services/navigation_service.cfm' target='_blank'>" + \
   ...
   def execute(self, parameters, messages):
      ...
      #------------------------------------------------------------------------
      try:
         sde_conn = arcpy.ArcSDESQLExecute("Database Connections\\OWDIDB_Postgres_Rad_Ags.sde");      
      ...
      sql_statement1 = """
         DO $$DECLARE 
            ...
            str_status_message VARCHAR(255);
            str_session_id     VARCHAR(40);
         BEGIN
            ...
            SET
             return_code    = r.pReturnCode
            ,status_message = r.pStatusMessage
            WHERE
      ...
      if sde_return[0][0] <> 0:
         arcpy.AddMessage("   Navigation completed with status code " + str(sde_return[0][0]));
         ...
         arcpy.SetParameterAsText(12,sde_return[0][0]);
      ...
      try:
         arcpy.FeatureClassToFeatureClass_conversion(
             "Database Connections\\OWDIDB_Postgres_Rad_Ags.sde\\rad_ags.tmp_navigation_results"
            ,arcpy.env.scratchGDB
            ,scratch_name
...
class NavigationDelineationService(object):
   ...
   def __init__(self):
      ...
      self.description = "The EPA Office of Water Navigation Delineation Service provides an areal representation of the " + \
         ...
         "For more information see " +  \
         "<a href='http://water.epa.gov/scitech/datait/tools/waters/services/navigationdelineationservice.cfm' target='_blank'>" + \
         "EPA service documentation</a>.";
      self.canRunInBackground = False
   ...
   def execute(self, parameters, messages):
      ...
      if parameters[14].valueAsText == "true":
         boo_split_catchment = True;
         str_split_catchment = "'TRUE'";
      else:
         boo_split_catchment = False;
         str_split_catchment = "'FALSE'";
      ...
      if str_feature_orig == "NHDPlus Catchments":
         str_feature_type = "CATCHMENT";
      elif str_feature_orig == "NHDPlus Catchments (Topo Agg)":
      ...
      if str_split_catchment is None:
         str_split_catchment = "NULL";
      ...
      sql_statement1 = """
         DO $$DECLARE 
            ...
            str_status_message   VARCHAR(255);
            str_session_id       VARCHAR(40);
            str_feature_type     VARCHAR(255);
            str_aggregation_flag VARCHAR(255);
         BEGIN
            str_session_id       := '""" + str_session_id   + """';
            str_feature_type     := '""" + str_feature_type + """';
            str_aggregation_flag :=  """ + str_aggregation  + """;
            INSERT INTO
            nhdplus_navigation.tmp_navigation_status(
               objectid
              ,session_id
            ...
            nhdplus_delineation.tmp_delineation_status(
               ...
               ,aggregation_flag
                ...
                nextval('nhdplus_delineation.tmp_delineation_status_seq')
               ,str_session_id
               ,(abstime(('now'::text)::timestamp(6) with time zone))
               ,str_feature_type
               ,str_aggregation_flag
            );
            r := nhdplus_delineation.basin_delineator(
                pNavigationType           := '""" + str_navigation_type  + """'
               ,pStartComID               := """  + str_start_comid      + """
               ,pStartPermanentIdentifier := """  + str_start_permid     + """
               ,pStartReachcode           := """  + str_start_reachcode  + """
               ...
               ,pFlowlineLists            := NULL
               ,pSplitInitialCatchment    := """  + str_split_catchment  + """
               ,pSessionID                := str_session_id
            );
      ...
      sql_statement2 = """
         ...
         ,a.status_message
         FROM
         rad_ags.tmp_delineation_status a
         WHERE
         a.session_id = '""" + str_session_id + """'
      """      
      ...
      if sde_return is None or isinstance(sde_return,(bool)):
         arcpy.AddMessage("   Error inspecting session id " + str_session_id);
         arcpy.AddError("   Navigation Delineation Failed");
         exit -1;
         
      if sde_return[0][0] <> 0:
         arcpy.AddMessage("   Delineation completed with status code " + str(sde_return[0][0]));
         ...
         arcpy.SetParameterAsText(17,sde_return[0][0]);
      ...
      try:
         arcpy.FeatureClassToFeatureClass_conversion(
             "Database Connections\\OWDIDB_Postgres_Rad_Ags.sde\\rad_ags.tmp_catchments"
            ,arcpy.env.scratchGDB
            ,scratch_name_delin
...
class PointIndexingService(object):
   ...
   def __init__(self):
      ...
      self.description = "The EPA Office of Water Point Indexing service provides a simplified point indexing function " + \
         ...
         "<a href='http://water.epa.gov/scitech/datait/tools/waters/services/point-indexing-service.cfm' target='_blank'>" + \
         "EPA service documentation</a>.";
      self.canRunInBackground = False;
   ...
   def execute(self, parameters, messages):
      ...
      sql_statement1 = """
         ...
         BEGIN
            ...
            sdo_input := ST_GeomFromText('""" + str_wkt_geom  + """',num_input_srid);
            ary_fcode_allow := ARRAY[""" + str_fcode_allow  + """]::integer[];
            ary_fcode_deny  := ARRAY[""" + str_fcode_deny  + """]::integer[];
            ...
            nhdplus_indexing.tmp_pt_indexing_status(
              ...
              ,session_datestamp
               ...
               nextval('nhdplus_indexing.tmp_pt_indexing_status_seq')
              ,str_session_id
              ,(abstime(('now'::text)::timestamp(6) with time zone))
            );
            r := nhdplus_indexing.flat_point_indexer(
                pPoint                  := sdo_input 
            ...
            UPDATE nhdplus_indexing.tmp_pt_indexing_status a
            SET
             return_code    = r.pReturnCode
            ,status_message = r.pStatusMessage
            WHERE
      ...
      sql_statement2 = """
         ...
         ,a.status_message
         FROM
         rad_ags.tmp_pt_indexing_status a
         WHERE
         a.session_id = '""" + str_session_id + """'
      """      
      ...
      if sde_return is None or isinstance(sde_return,(bool)):
         arcpy.AddMessage("   Error inspecting session id " + str_session_id);
         arcpy.AddError("   Point Indexing Failed");
         exit -1;
      ...
      #------------------------------------------------------------------------
      if sde_return[0][0] <> 0:
         arcpy.AddMessage("   Point Indexing completed with status code " + str(sde_return[0][0]));
      ...
      try:
         arcpy.FeatureClassToFeatureClass_conversion(
             "Database Connections\\OWDIDB_Postgres_Rad_Ags.sde\\rad_ags.tmp_pt_start"
            ,arcpy.env.scratchGDB
            ,scratch_name_sp
            ,"session_id = '" + str_session_id + "'" 
         );
      ...
      try:         
         arcpy.FeatureClassToFeatureClass_conversion(
             "Database Connections\\OWDIDB_Postgres_Rad_Ags.sde\\rad_ags.tmp_pt_end"
            ,arcpy.env.scratchGDB
            ,scratch_name_ep
            ,"session_id = '" + str_session_id + "'" 
         );
         ...
         arcpy.FeatureClassToFeatureClass_conversion(
             "Database Connections\\OWDIDB_Postgres_Rad_Ags.sde\\rad_ags.tmp_pt_indexingline"
            ,arcpy.env.scratchGDB
            ,scratch_name_ip
            ,"session_id = '" + str_session_id + "'" 
         );
      ...
      try:
         arcpy.FeatureClassToFeatureClass_conversion(
             "Database Connections\\OWDIDB_Postgres_Rad_Ags.sde\\rad_ags.tmp_pt_flowlines"
            ,arcpy.env.scratchGDB
            ,scratch_name_fl
            ,"session_id = '" + str_session_id + "'" 
         );
